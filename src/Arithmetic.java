...
public class Arithmetic {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("El resultado de la suma de " + entero1 + " + " + entero2 + " = " + suma); //En la pantalla pone los dos numeros y
        //el resultado de suma
        System.out.println("El resultado de la resta de " + entero1 + " - " + entero2 + " = " + resta); //Pone los numeros que puso el usuario
        //y su resta
        System.out.println("El resultado de la multiplicacion de " + entero1 + " * " + entero2 + " = " + multi); //Pone en pantalla los
        //numeros que el usuario uso y el resultado de la multiplicacion de ellos
        ...
        System.out.println(base + " ^ " + exponente + " = " + power); // presenta los numeros que el usuario uso y su r
    }
}
